...
try {
  ...
  assert.equal(new URL(pagina.url()).pathname, '/proyectos/1', 'El evento navegar no saca del proyecto.')
  ...
  await pagina.goto(new URL('/proyectos/2?tab=wibot', destino).href, { waitUntil: 'networkidle' })
