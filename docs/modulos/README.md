...
| [09](09-jerarquias.md) | Jerarquías del equipo | `tblareas` (`area_superior_id`, `jefe_staffid`) y `tblstaff.area_id` | sí | sí | Es el dato que le faltaba a En Vivo. El catálogo de 16 áreas existe pero el árbol está **vacío**: 0 con superior, 0 con jefatura y 184 personas sin área. Cargarlo es trabajo de las jefaturas, y la pantalla existe para que no sea un `UPDATE` |
