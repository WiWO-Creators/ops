...
Rama integrada en ambos repositorios: `main` (origen: `feat/solicitudes-ops`).

Directorios de entrega: `/home/wiwo/ops.wiwo/ops-v2` y `/home/wiwo/ops.wiwo/wiwo-board`. Los worktrees siguientes conservan la implementación original.
...
- `npm test`: 800 pruebas correctas tras integrar calendario, hitos y horas estimadas del `main` local.
