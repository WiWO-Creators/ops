...
| Leer los Meeting Papers como contexto de Thinking Orb | ✅ `main` (`4df266f`, cableado en `0f95706`) | — | Herramienta `actas_del_espacio`. El markdown se **deriva del HTML al leer**, sin columna nueva: una copia guardada se desincroniza el día que alguien edite el acta y Thinking Orb citaría una versión que ya nadie ve. Un acta real pasa de 1.403 a 965 caracteres |
