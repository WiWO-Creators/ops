 ...
 * detalle de una pantalla: el dia que entre una sociedad nueva, o que una cambie de nombre, la
...
/**
 * Las sociedades del holding, en el orden en que el equipo las nombra.
 *
