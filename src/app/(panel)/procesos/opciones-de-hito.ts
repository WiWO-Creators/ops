 ...
 * lado: sin Espacio, la lista sale vacia y `ControlesTabla` dibuja el desplegable deshabilitado con
 * la pista de elegir primero un Espacio —lo declara `Filtro.dependeDe`—, porque hasta entonces no se
 * sabe de que Espacio son los hitos que habria que ofrecer.
 *
