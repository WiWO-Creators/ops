...
export const metadata: Metadata = { title: 'Verifica tu correo · Portal de clientes' }
  ...
  return (
    <main className="fondo-marca grid h-dvh place-items-center overflow-y-auto p-6">
      <PanelVidrio className="w-full max-w-md p-8">
        <Logo />
        <h1 className="font-titular text-texto mt-6 text-xl font-semibold">Verifica tu correo</h1>
        <p className="text-texto-tenue mt-2 text-sm">
          Te enviamos un enlace de verificación al correo con el que entraste. Ábrelo para poder ver
          tus proyectos y documentos.
        </p>
        <p className="text-texto-sutil mt-4 text-sm">
          Si no te llegó, escríbenos y te lo reenviamos.
        </p>
      </PanelVidrio>
    </main>
  )
