...
/** El control de dos estados vive en `formularios/Interruptor`: ya lo usan accesos y los adjuntos. */
export { Interruptor } from '@/componentes/formularios/Interruptor'
