...
export const PROCESOS: DefinicionRecurso<Proceso> = {
  ...
  filtros: [
    { clave: 'assignee', etiqueta: 'Asignado (ID)', tipo: 'campo', tipoDato: 'numero' },
    { clave: 'followers', etiqueta: 'Seguidores', tipo: 'campo', tipoDato: 'texto' },
    ...
    { clave: 'assignees', etiqueta: 'Asignados', tipo: 'campo', tipoDato: 'texto' },
    { clave: 'tags', etiqueta: 'Etiquetas', tipo: 'campo', tipoDato: 'texto' },
    { clave: 'task_type_name', etiqueta: 'Tipo', tipo: 'campo', tipoDato: 'texto' },
    ...
    { clave: 'billed', etiqueta: 'Facturado', tipo: 'campo', tipoDato: 'booleano' },
    ...
    { clave: 'is_public', etiqueta: 'Público', tipo: 'campo', tipoDato: 'booleano' },
    { clave: 'visible_to_client', etiqueta: 'Visible al cliente', tipo: 'campo', tipoDato: 'booleano' },
    { clave: 'recurring', etiqueta: 'Recurrente', tipo: 'campo', tipoDato: 'booleano' },
